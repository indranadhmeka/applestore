...
const AppleTVPlusPage = () => {
  const videos = [
    { title: "Apple TV+ – Cinematic Trailer", src: "/media/appletv/trailer1.mp4" },
    { title: "Apple TV+ – Series Highlights", src: "/media/appletv/trailer2.mp4" },
  ];

  return (
    <div className="bg-black text-white min-h-screen p-10">
      <h1 className="text-4xl font-bold mb-10 text-center">Apple TV+</h1>
